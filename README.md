...
> Projeto de estudos e prática em testes de API REST desenvolvido durante a formação completa em Quality Assurance. Cobre desde os fundamentos de HTTP até a automação com Newman, testes orientados a dados e geração de relatórios profissionais.
...
A jornada passou por fundamentos de HTTP, leitura de contratos Swagger, criação de testes automatizados, execução em escala com dados externos e publicação de relatórios em HTML — tudo o que um QA Engineer precisa no dia a dia.
...
Criação de workspaces e estruturação profissional de collections no Postman, com foco na organização e reuso.
...
![Runner](docs/assets/Teste_Runner.png)
